...
$qry="SELECT tom.*,tpd.BlueBookCode FROM  `tblordersmaster` tom LEFT JOIN tblprogramdirectors tpd ON tom.ProgramDirectorsID = tpd.ProgramDirectorsID WHERE tom.`OrderApproved`='Pending'";
    	...
    	<div class="smart-forms smart-container wrap-2">
            ...
            <div class="wrap-2">
                ...
                <div class="spacer-t40 spacer-b40">
                	<div class="tagline"><span class="large-text">PENDING ORDERS </span></div><!-- .tagline -->
                </div>
                <?php 
                if($items!='NOT_FOUND'){
                ?>
                <table id="pd-table">
                    <thead><tr><th>Order Number</th><th>Blue Book Code</th><th>Facility Name</th><th>Ship Type</th>
                            <th>Order Placed By Address</th><th>Order Date</th><th colspan="2">Controls</th></tr></thead>
                    <tbody>
                    <?php  while($item=$result_data->fetch_assoc()){  ?>
                        <tr>
                            ...
                            <?php }*/?>
                            <td><a title="View Order" href="caap-order-line-items.php?oid=<?php echo $item['OrderNumber'];?>&user=caap"><i class="icon-view"></i></a></td>
                        </tr>
                    <?php }  ?>
                    </tbody>
                </table>
