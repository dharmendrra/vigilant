...
<body class="woodbg">
	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
            ...
            <?php }else{ ?>
            <style>#menu ul{right:10px!important;}#menu ul li a{padding:15px 5px 20px 10px!important;}</style>
            <div class="form-header header-primary" id="menu">
            ...
            <div class="wrap-2">
                ...
                ?>
                <table id="pd-table">
                    <thead><tr><th>Equipment</th><th>Part Number</th><th>Description</th><th>Quantity</th><th><a href="caap-order.php?oid=<?php echo $_REQUEST['oid'];?>&order=<?php echo $orderBy;?>&column=LineItemApproved&status=<?php echo (isset($_REQUEST['status'])?$_REQUEST['status']:'')?>&user=<?php echo (isset($_REQUEST['user'])?$_REQUEST['user']:'')?>">Status</a></th><?php if(!isset($_REQUEST['status']) || $_REQUEST['status']!='apr'){ ?><th>Controls</th><?php } ?></tr></thead>
                    <tbody></tbody>
                    <?php  
                    $orderButton='ENABLE';
