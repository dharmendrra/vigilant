...
if(isset($_POST['submit'])){
    ...
    $flag=true;
    $qry="SELECT * FROM `tbluseraccounts` WHERE `tbluseraccounts`.`EmailAddressUser`='".$mysqli->real_escape_string($_POST['EmailAddress'])."'";
    $result = $mysqli->query($qry) or die($mysqli->error.' '.$qry);
    if($result->num_rows<=0){
        //insert query- to feed posted tblprogramdirectors
        $insertQuery = "INSERT INTO `tbluseraccounts` (`FirstNameUser`,`LastNameUser`, `EmailAddressUser`,`PasswordUser` `ActiveUser`) VALUES 
	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
            ...
            <div class="form-header header-primary" id="menu">
    			...
    			<ul id="menuse">
                    <li><a href="add-user-account.php" class="">Add User</a></li>
                    <li><a href="parts.php" class="">Parts</a></li>
                    ...
                    <div class="frm-row">
                        <div class="colm colm6">    
                            <div class="section">
                                ...
                                <label class="field">
                                    <input required="true" type="text" name="Password" id="Password" class="gui-input" placeholder="Password"><li class="form-row" id="random" style="display: list-item;">P+Ek%kxJL|+*</li>
                                </label>
                            </div><!-- end section -->
                        ...
                        <div class="colm colm6">    
                            <div class="section heading">
                                <label for="SiteName" class="link-password field-label" id="confirm">Use Password</label>
                                <label class="field">
