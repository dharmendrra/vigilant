...
$qry="SELECT * FROM `tblprogramdirectors` WHERE CustomerID='0' AND ShipToID='0' AND Active!='Yes' ORDER BY BlueBookCode";
$result_data = $mysqli->query($qry) or die($mysqli->error.' '.$qry);
    	...
    	<div class="smart-forms smart-container wrap-2">
            ...
            <div class="form-header header-primary" id="menu">
    			...
    			<ul id="menuse">
                    ...
                    <li><a href="unprocessed-program-director.php" class="">Unprocessed Program Directors</a></li>
                        ...
                        <table id="pd-table">
                            ...
                            <?php while($item=$result_data->fetch_assoc()){ 
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "(".substr($item['PhoneNumber'], 0, 3).") ".substr($item['PhoneNumber'], 3, 3)."-".substr($item['PhoneNumber'],6);;?></td>
