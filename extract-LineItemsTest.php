...
/*
    ...
    */
	...
	$select_table=$mysqli->query("SELECT tom.OrderNumber,tom.PartNumber,CONCAT(MONTH(tom.DateOrdered), DAY(tom.DateOrdered), YEAR(tom.DateOrdered)) AS DateOrdered, 4 AS HardCodedField, tom.QtyOrdered,tom.LineItemApproved FROM `tblorderlineitem` tom");
