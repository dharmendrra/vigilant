...
if($_POST['submit']!=""){
        /*
        //log into database
       $qryRAC = "INSERT INTO tblAddressChangeRequest (FacilityName,CompanyAddress1,CompanyAddress2,Notes)VALUES(
       ...
       */
            ...
            $subject = "Parts Ordering:: Address Change Request";//Program Director
...
$qry_bbc="SELECT tpd.BlueBookCode,thsm.FacilityName FROM `tblprogramdirectors` tpd , `tblhealogicssitemaster` thsm WHERE `tpd`.BlueBookCode = `thsm`.BlueBookCode AND tpd.`Log-inID` = '".$_SESSION['USER_INFO']['Log-inID']."'";
...
if($display == false || $_REQUEST['bbcode']){
    ...
    $qry="SELECT tpd.ProgramDirectorsID,tpd.`Log-inID`,tpd.EmailAddress ,tpd.BlueBookCode,tpd.FirstName,tpd.LastName,thsm.CustomerID,thsm.ShipToID,thsm.CompanyAddress1,thsm.FacilityStatus,thsm.CompanyAddress2,thsm.FacilityName,thsm.City,thsm.State,thsm.Zip,thsm.Country  FROM `tblprogramdirectors` tpd , `tblhealogicssitemaster` thsm WHERE `tpd`.BlueBookCode = `thsm`.BlueBookCode AND tpd.`Log-inID` = '".$_SESSION['USER_INFO']['Log-inID']."' AND  thsm.`BlueBookCode` LIKE '".($_REQUEST['bbcode'] ? $_REQUEST['bbcode'] : $bbcode)."'";
    ...
    if($result_data->num_rows<=0){
        ...
        $displayTab = true;
        $result_LI = $result_data->fetch_assoc();
    }   
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <style>table#pd-table thead th, table#pd-table tbody td {padding: 0.5em 0.4em .5em .4em;}.wrap-2{max-width: 950px;}.large-text{font-size: 1.6em!important;font-family: calibri!important;line-height: 1.3;text-shadow: 0 0.4px 1px rgb(74, 73, 87);}.align-div{width: 150px;float: left;text-decoration: underline;}#menu ul{right:10px!important;}#menu ul li a{padding:15px 5px 20px 10px!important;}
    /*responsive */
	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-2">
        	...
        	<div class="form-body">
                ...
                if($_REQUEST['bbcode']){ ?>
                    <div class="frm-row">
                        ...
                        <div class="colm colm6">                   
                            ...
                            <label class="field large-text fine-black"> <div class="align-div">ShipID</div><?php echo $result_LI['ShipToID'];?></label>
                        </div>
                ...
                <p>Address changes are not immediate and must be approved. Please submit address change and confirmation will be sent when updated. Process may take up to 24 hours for change approval.<br /><br /></p>
                
                <div class="colm colm6">
                    <div class="section">
                        <label for="bbcode" class="field-label">Site Selector</label>
                        <label for="bbcode" class="field select">
                               <select name="bbcode" id="bbcode" onchange="if(this.value){window.location.href='request-address-change.php?bbcode='+this.value;}">
                ...
                <div  class="form-body" <?php if($_REQUEST['bbcode']){ echo 'style="display:block;"'; }else{ echo 'style="display:none;"'; }?>>
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="FacilityName" class="field">
                                    <input required="true" type="text" name="FacilityName" id="FacilityName" class="gui-input" placeholder="Enter Facility Name" value="<?php echo $result_LI['FacilityName']?>">
                                </label>
                            </div><!-- end section -->
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="CompanyAddress1" class="field">
                                    <input required="true" type="text" name="CompanyAddress1" id="CompanyAddress1" class="gui-input" placeholder="Enter CompanyAddress1" value="<?php echo $result_LI['CompanyAddress1']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                    </div>
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="CompanyAddress2" class="field">
                                    <input required="true" type="text" name="CompanyAddress2" id="CompanyAddress2" class="gui-input" placeholder="Enter CompanyAddress2" value="<?php echo $result_LI['CompanyAddress2']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="City" class="field">
                                    <input required="true" type="text" name="City" id="City" class="gui-input" placeholder="Enter City" value="<?php echo $result_LI['City']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                    </div>
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="State" class="field">
                                    <input required="true" type="text" name="State" id="State" class="gui-input" placeholder="Enter State" value="<?php echo $result_LI['FacilityName']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="Zip" class="field">
                                    <input required="true" type="text" name="Zip" id="Zip" class="gui-input" placeholder="Enter Zip" value="<?php echo $result_LI['Zip']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                    </div>
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="Country" class="field">
                                    <input required="true" type="text" name="Country" id="Country" class="gui-input" placeholder="Enter Country" value="<?php echo $result_LI['Country']?>">
                                </label>
                            </div><!-- end section -->
                        </div><!-- end .colm6 section -->
                    </div>
                    ...
                    <div class="colm colm12">
                        <div class="section">
                            ...
                            <label for="RequestNotes" class="field prepend-icon">
                            	<textarea class="gui-textarea" id="RequestNotes" name="RequestNotes" placeholder="Add Notes"></textarea>
                ...
                <input type="submit" name="submit" id="submit" value="submit" class="button btn-primary" />
                </form>    
                </div>
