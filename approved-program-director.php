...
if(isset($_REQUEST['pd'])){
    ...
    if($result_data->num_rows>0){
        ...
        $to = $result_data_array['EmailAddress'];
            $subject = "Parts Ordering:: Your profile has been Updated";//Program Director
...
<html lang="en">
  <head>
  	<title> Parts Ordering:: UnProcessed SITE-ID </title>
    <meta charset="utf-8">
    ...
    <style>table#pd-table thead th, table#pd-table tbody td {padding: 0.5em 0.4em .5em .4em;}.smart-forms .form-body {min-height: 500px;}#menu ul{right:10px!important;}#menu ul li a{padding:15px 5px 20px 10px!important;}/*.edit-pencil-square{background-image: url('images/edit.png');height: 45px;width: 54px;}*/</style>
</head>
            ...
            <div class="form-header header-primary" id="menu">
            	...
            	<div class="form-body">
                    ...
                    <div class="frm-row">
                        ...
                        ?>
                        <table id="pd-table">
                            <thead><tr><th>First Name</th><th>Title</th><th>Facility Name</th><th>Email Address</th><th>Phone Number</th><th>Blue Book Code</th><!--<th>Address</th>--><th>Controls</th></tr></thead>
                            <?php while($item=$result_data->fetch_assoc()){ 
                                $address='';$name='';
                                /*
                                $address[]=$item['CompanyAddress1'];
                                if($item['CompanyAddress2']):
                                ...
                                */
                                ...
                                <tr>
                                    ...
                                    <td><a title="Edit" href="edit-program-director.php?pd=<?php echo $item['ProgramDirectorsID'];?>"><i class="icon-edit"></i></a></td>
                                </tr>
                            <?php }  ?>
                        </table>
                        <?php } ?>
