...
if(isset($_POST['submitOrder'])){
    ...
    $insertOrdQuery = "INSERT INTO `tblordersmaster` (`OrderNumber`,`ProgramDirectorsID`, `SiteName`, `BlueBookCode`,`CompanyAddress1`,`CompanyAddress2`,`City`, `State`,`Country`,`Zip`,`FirstName`, `LastName`, `EmailAddress`, `CustomerID`, `ShipToID`,`ShipType`,`PromisedDate`,`PONumber`,`OrderPlacedByAddress`,`DateOrdered`,`OrderApproved`) VALUES ('".($OrdNum)."', '".$_SESSION['PD_INFO']['ProgramDirectorsID']."', '".$_SESSION['PD_INFO']['FacilityName']."', '".$_SESSION['PD_INFO']['BlueBookCode']."', '".$_SESSION['PD_INFO']['CompanyAddress1']."', '".$_SESSION['PD_INFO']['CompanyAddress2']."', '".$_SESSION['PD_INFO']['City']."', '".$_SESSION['PD_INFO']['State']."', '".$_SESSION['PD_INFO']['Country']."', '".$_SESSION['PD_INFO']['Zip']."', '".$_SESSION['PD_INFO']['FirstName']."', '".$_SESSION['PD_INFO']['LastName']."', '".$_SESSION['PD_INFO']['EmailAddress']."', '".$_SESSION['PD_INFO']['CustomerID']."', '".$_SESSION['PD_INFO']['ShipToID']."','".$mysqli->real_escape_string($shipType)."','".$PromisedDate."','".$PONumber."','".$mysqli->real_escape_string($_SESSION['USER_INFO']['EmailAddressUser'])."','".date('Y-m-d h:i:s')."','Pending')";
...
$qry="SELECT tpd.ProgramDirectorsID,tpd.`Log-inID`,tpd.EmailAddress ,tpd.BlueBookCode,tpd.FirstName,tpd.LastName,thsm.CustomerID,thsm.ShipToID,thsm.CompanyAddress1,thsm.CompanyAddress2,thsm.FacilityName,thsm.City,thsm.State,thsm.Zip,thsm.Country  FROM `tblprogramdirectors` tpd , `tblhealogicssitemaster` thsm WHERE `tpd`.BlueBookCode = `thsm`.BlueBookCode AND EEStatus='A' group by tpd.BlueBookCode ORDER BY BlueBookCode";
            ...
            <form method="post" action="" id="lineItemForm" enctype="multipart/form-data" onsubmit="//return validate_lineItem();">
            	<div class="form-body">
                    ...
                    <div class="colm colm6">
                        <div class="section">
                            <label for="pd-selector" class="field-label">Minimize Facility List (enter Blue Blue Book ID):</label>
                    ...
                    <div class="frm-row">
                        ...
                        <div class="colm colm6">                   
                            ...
                            <label class="field large-text fine-black"> <div class="align-div">Email</div><?php echo $_SESSION['PD_INFO']['EmailAddress'];?></label><br />
                            <label class="field large-text fine-black"> <div class="align-div" style="width: 220px;">Blue Book Code</div><?php echo $_SESSION['PD_INFO']['BlueBookCode'];?></label>
                        </div>
