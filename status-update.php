...
function notifyProgramDirector($lineitem_id,$mysqli){
    ...
    $result_LI = $mysqli->query($qryLI) or die($mysqli->error.' '.$qryLI);
    if($result_LI->num_rows>0){
        ...
        $message = "
            ...
            <body>
                <p>A Line Item from the Order Number <u>".$result_LI['OrderNumber']."</u></p>
            ...
            <p><a href='".SITE_PATH."'>Click here</a></p>
            </body>
            </html>
            ";//Customer Service
