...
<html lang="en">
  <head>
  	<title> Parts Ordering:: Customer Service </title>
    <meta charset="utf-8">
    ...
    <style>table#pd-table thead th, table#pd-table tbody td {padding: 0.5em 0.4em .5em .4em;}.wrap-2{max-width: 950px;}.smart-forms button[disabled]{opacity: 1!important;background-color: #319ACD!important;}.smart-forms .gui-input.extra-light{font-size:15px;border: 1px solid black!important;color: black!important;}#menu ul{right:10px!important;}#menu ul li a{padding:15px 5px 20px 10px!important;}</style>
                        ...
                        <div class="colm colm6">
                            <div class="section">
                                ...
                                <label for="MaxUnit" class="field">
                                    <input required="true" type="text" name="MaxUnit" id="MaxUnit" class="gui-input" placeholder="Enter Quantity" value="<?php echo $part_data['MaxUnit'];?>">
                                </label>
                            </div><!-- end section -->
