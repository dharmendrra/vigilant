...
function _MakePWDWidget()
{
	...
	code += "<input required='true' type='password' class='gui-input' name='"+pwdname+"' id='"+this.pwdfieldid+"' placeholder='Enter New Password'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input required='true' type='text' class='gui-input' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;' placeholder='Enter New Password'>";
