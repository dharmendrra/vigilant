...
$qry="SELECT tom.*,tpd.EmailAddress AS OrderedBy FROM  `tblordersmaster` tom LEFT JOIN tblprogramdirectors tpd ON tom.ProgramDirectorsID = tpd.ProgramDirectorsID WHERE tom.`OrderApproved`='Approved' ";
