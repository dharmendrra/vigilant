...
$qry="SELECT * FROM  `tblordersmaster` WHERE `OrderApproved`='Pending'";
                ...
                <table id="pd-table">
                    ...
                    <?php  while($item=$result_data->fetch_assoc()){  ?>
                        <tr>
                            ...
                            <?php }?>
                            <td><a title="View Order" href="caap-order.php?oid=<?php echo $item['OrdersMasterID'];?>"><i class="icon-view"></i></a></td>
                        </tr>
                    <?php }  ?>
                    </tbody>
                </table>
