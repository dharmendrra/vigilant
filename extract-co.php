...
/*
    ...
    */
    ...
    $select_table=$mysqli->query("SELECT tom.OrderNumber,tom.CustomerID,tom.ShipToID,tom.PONumber,tom.ShipType FROM `tblordersmaster` tom LEFT JOIN tblprogramdirectors tpd ON tom.ProgramDirectorsID = tpd.ProgramDirectorsID WHERE tom.`ProcessedFS` = 'No' ");
    ...
    */
    ...
    readfile($file);
    copy('CreateCO.csv','extract/CreateCO.csv');
    unlink('CreateCO.csv');
?>