...
function notifyProgramDirector($lineitem_id,$mysqli){
    ...
    if($result_rs_LI->num_rows>0){
        ...
        $message = "
            ...
            <body>
                <p>This is a notification that an item has been denied on the Order Number <u>".$result_LI['OrderNumber']."</u>. Please contact Healogics at (904)446-3520.</p>
            ...
            <p><a href='".SITE_PATH."'>Click here</a> to visit Sechrist Parts Ordering Portal.</p>
            </body>
            </html>
            ";//Customer Service
